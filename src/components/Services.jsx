...
const Services = () => {
    return (
        <section id="services" className="py-20 bg-emerald-50/40 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-gray-500 max-w-xl mx-auto">Comprehensive medical services designed for your well-being.</p>
                </motion.div>
